...
<body>
    ...
    <div id="ascensorBuilding">
        ...
        <section class="floor floor-1">
            <div id="home-image">
                <div id="home-title">
                    <h1><span class="mobile-title">SAMEER</span><span>THITE</span></h1>
                    <p>Web Designer</p>
                </div>
                <!-- SOCIAL ICONS -->
                <div id="cv-home-social-bar-container">
                    <a href="resume/resume.doc" class="cv-button my-file">Download Resume</a>
        ...
        <section class="floor floor-2">
            ...
            <div class="cv-page-content">
                ...
                <h3>Name: Sameer Kailas Thite</h3>
                
                <!-- TABLE -->
                <ul class="cv-table">
                    <li>
                        <div class="cv-table-left"><i class="cv-icon fa fa-user"></i>Date of birth</div>
                        <div class="cv-table-right">April 7th 1991</div>
                    </li>
                    <li>
                        <div class="cv-table-left"><i class="cv-icon fa fa-language"></i>Languages</div>
                        <div class="cv-table-right">English, Hindi & Marathi</div>
                    </li>
                    <li>
                        <div class="cv-table-left"><i class="cv-icon fa fa-futbol-o"></i>Hobbies</div>
                        <div class="cv-table-right">Soccer, Travel, </div>
                    </li>
                    <li>
                        <div class="cv-table-left"><i class="cv-icon fa fa-external-link-square"></i>Website</div>
                        <div class="cv-table-right"><a href="#">sameerthite.in</a>
                        </div>
                    </li>
                </ul>
                <h2 class="border">CAREER OBJECTIVE</h2>
                <p>Looking for a suitable Web Designer’s position in a high profile company for the development of my skills and knowledge and hence for the growth of the firm.</p>
                <a href="#contact" class="cv-button primary go-to-floor" data-id="5" data-slug="contact">Hire Me</a>
                <a href="resume/resume.doc" class="cv-button my-file">Download Resume</a>
                <hr/>
                <h2 class="border">WHAT CAN I DO</h2>
                <div class="cv-main-icon-container" style="margin:0 auto;">
                   <h4>
                   	HTML5<br>
                   	CSS3<br>
                   	Jquery<br>
            ...
            <div class="cv-page-content">
                ...
                <div class="cv-resume-box">
                    <div class="cv-resume-title">
                        <h5>Web & Graphics Designer - Bee Technologies</h5>
                        <p>Sep 2014 to present</p>
                    </div>
                    <p>Designed Websites and Mobile Applications.</p>
                </div>
                <hr/>
                ...
                <div class="cv-resume-box">
                    ...
                    <p>College: G. H. Raisoni College, Wagholi, Pune.</p>
                </div>
                <div class="cv-resume-box">
                    <div class="cv-resume-title">
                        <h5>Bachlor of Science (BSc)</h5>
                        <p>2008-2011</p>
                    </div>
                    <p>College: S. M. Joshi College, Hadapsar, Pune.</p>
                </div>
                <hr/>
                ...
                <div class="skills">
                    ...
                    <div class="skillbar" data-percent="60%">
                        <div class="skillbar-title"><span>AngularJs</span>
                        </div>
                        <div class="skillbar-bar"></div>
                        <div class="skill-bar-percent">60%</div>
                    </div>
                    <div class="skillbar" data-percent="70%">
                        <div class="skillbar-title"><span>Bootstrap</span>
                        </div>
                        <div class="skillbar-bar"></div>
                        <div class="skill-bar-percent">70%</div>
                    </div>
                    <div class="skillbar" data-percent="55%">
                        <div class="skillbar-title"><span>Illustrator</span>
                        </div>
                        <div class="skillbar-bar"></div>
        ...
        <section class="floor floor-4">
            ...
            <div class="cv-page-content">
                ...
                <ul id="cv-portfolio-filter" class="cvfilters">
                    ...
                    <li data-filter="cat1">Websites</li>
                    <li data-filter="cat2">Mobile Apps</li>
                </ul>
                <div class="clear"></div>
                <!-- PORTFOLIO GRID -->
                <ul id="cv-portfolio" class="cvgrid">
                    <li data-filter-class='["all","cat1"]'>
                        <figure>
                            ...
                            <figcaption>
                                <div class="cvgrid-title">IKCOC</div>
                            </figcaption>
                        </figure>
                    </li>
                    <li data-filter-class='["all","cat1"]'>
                        <figure>
                            <a id="gallery2" href="#" class="cvgrid-img">
                                <img src="images/photos/p2-thumb.jpg" alt="" />
                            </a>
                            <figcaption>
                                <div class="cvgrid-title">GSA Academy</div>
                            </figcaption>
                        </figure>
                    </li>
                    <li data-filter-class='["all","cat1"]'>
                        <figure>
                            <a id="gallery3" href="#" class="cvgrid-img">
                                <img src="images/photos/p3-thumb.jpg" alt="" />
                            </a>
                            <figcaption>
                                <div class="cvgrid-title">EMA Hospitality</div>
                            </figcaption>
                        </figure>
                    </li>
                    <li data-filter-class='["all","cat1"]'>
                        <figure>
                            ...
                            <figcaption>
                                <div class="cvgrid-title">Santushti Caterers</div>
                            </figcaption>
                        </figure>
                    </li>
                    <li data-filter-class='["all","cat1"]'>
                        <figure>
                            <a id="gallery5" href="#" class="cvgrid-img">
                                <img src="images/photos/p5-thumb.jpg" alt="" />
                            </a>
                            <figcaption>
                                <div class="cvgrid-title">CropsApp</div>
                            </figcaption>
                        </figure>
                    </li>
                    <li data-filter-class='["all","cat1"]'>
                        <figure>
                            <a id="gallery6" href="#" class="cvgrid-img">
                                <img src="images/photos/p6-thumb.jpg" alt="" />
                            </a>
                            <figcaption>
                                <div class="cvgrid-title">BEE HRMS</div>
                            </figcaption>
                        </figure>
                    </li>
                    <li data-filter-class='["all","cat1"]'>
                        <figure>
                            <a id="gallery7" href="#" class="cvgrid-img">
                                <img src="images/photos/p7-thumb.jpg" alt="" />
                            </a>
                            <figcaption>
                                <div class="cvgrid-title">Dream Makers Event Services</div>
                            </figcaption>
                        </figure>
                    </li>
                    <li data-filter-class='["all","cat1"]'>
                        <figure>
                            <a id="gallery8" href="#" class="cvgrid-img">
                                <img src="images/photos/p8-thumb.jpg" alt="" />
                            </a>
                            <figcaption>
                                <div class="cvgrid-title">Sufie-e-Hind</div>
                            </figcaption>
                        </figure>
                    </li>
                </ul>
            ...
            <div class="cv-page-content">
                ...
                <ul class="cv-table">
                    <li>
                        ...
                        <div class="cv-table-right">+91 8237090106</div>
                    </li>
                    <li>
                        <div class="cv-table-left"><i class="cv-icon fa fa-envelope"></i>E-mail</div>
                        <div class="cv-table-right"><a href="#">sameer.thite@rediffmail.com</a>
                        </div>
                    </li>
                    <li>
                        <div class="cv-table-left"><i class="cv-icon fa fa-map"></i>Address</div>
                        <div class="cv-table-right">Sr. No. 14, Thite Nagar, Kharadi, Pune -14.</div>
                    </li>
                </ul>
